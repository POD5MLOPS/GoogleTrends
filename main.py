...
# Add a cover photo to the app
cover_photo = Image.open("logo.png")
resized_cover_photo = cover_photo.resize((800, 250))
st.image(resized_cover_photo, use_column_width=True)
...
linesDeduped2 = []
MAX_LINES = 5
text2 = st.markdown("Get your Top & Rising trends for 5 keywords, directly from Google Trends.")
...
text = st.text_area("by POD5", height=150, key=1)
...
if len(linesList) > MAX_LINES:
    st.warning(f"The first 5 keywords will be reviewed.)")
